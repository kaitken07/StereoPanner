...
void StereoPannerAudioProcessorEditor::resized()
{
    ...
    sliderPanPosition->setBounds (16, 16, 152, 304);
...
<JUCER_COMPONENT documentType="Component" className="StereoPannerAudioProcessorEditor"
  ...
  <SLIDER name="new slider" id="88db7b9571c0636a" memberName="sliderPanPosition"
          virtualName="" explicitFocusOrder="0" pos="16 16 152 304" min="-1"
